...
from attentionpooling import AdditiveAttention1D
...
attn = AdditiveAttention1D(hdims)
q1 = pool(x1, mask=x1_mask)
q2 = pool(x2, mask=x2_mask)

x1, w1 = attn([x1, q2], mask=x1_mask)
x2, w2 = attn([x2, q1], mask=x2_mask)
